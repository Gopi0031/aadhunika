    ...
    <section className="about-page">
      ...
      <div className="about-split">
        <div className="about-text">
          ...
          <p>
            ...
            dedicated to delivering high-quality, patient-centric medical
            services. We integrate advanced medical technology with
            compassionate care to ensure safe, ethical, and effective treatment
            for every patient.
          </p>
          <p>
      ...
      <div className="about-cards">
        <div className="about-card">
          <h2>Our Mission</h2>
          <p>
            To enhance the well-being of our community and lead the way in
            modern healthcare by providing ethical, accessible, and advanced
      ...
      <div className="about-split reverse">
        ...
        <div className="about-text">
          ...
          <ul>
            <li>
              Experienced and qualified doctors supported by skilled medical
              staff
            </li>
